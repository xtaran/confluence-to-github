...
sed -i .org 's/&aring;/å/g' entities.xml

sed -i .org 's/&Ccedil;/Ç/g' entities.xml
...
sed -i .org 's/&ouml;/ö/g' entities.xml
sed -i .org 's/&OElig;/Œ/g' entities.xml
...
sed -i .org 's/&sup1;/¹/g' entities.xml
sed -i .org 's/&sup2;/²/g' entities.xml
sed -i .org 's/&not;/¬/g' entities.xml