...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <!-- 
      ...
      have been deleted. We only want the first version of each page.
    -->
    <xsl:apply-templates select="/hibernate-generic/object[@class='Page' and boolean(property[@name='version'][text()='1'])]"/>
